...
class ModuleBuilderImpl<S, R> implements ModuleBuilder<S, R> {
    ...
    protected _plugins: Plugin<S>[] = [];
    protected _strict: boolean = false;
    protected _moduleBuilders: Dictionary<ModuleBuilder<any, any>> = {};
    ...
    module<M>(namespace: string, initialState?: M): ModuleBuilder<M, R> {
        ...
        const nestedBuilder = <any>new ModuleBuilderImpl(qualifiedNamespace, initialState);
